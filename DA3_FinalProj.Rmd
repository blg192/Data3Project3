...
## need to switch up MSE so that it accounts for bigger set

## also try lagging rf with lag equal to 6 months
...
df2 <- data.frame("Model" = c("Baseline: Climatology",
                  ...
                  "Test MSE" = c(Accuracy_climatology, testmsepers, 
                                 MSE_CNN_naive_cont, MSE_KPCA_cont))
...
## Conclusion
- CNN: Issues with classification problems due to the nature of the classes
