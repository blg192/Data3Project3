...
>>>>>>> e8ad691156e418ad87283a60dbfaf1a712c94c09
...
<<<<<<< HEAD
```{r SSTPC1s, echo=FALSE, results='asis', fig.cap = '\\label{fig:SSTPC1s} Plot of PC1 from PCA and KPCA for SST data.', fig.align = 'center'}
=======
...
=======
PKPCAclustout <- data.frame(LongLat, Cluster = factor(PKPCAclustres$cluster))
colnames(KPCAclustout) <- c('Longitude', 'Latitude', 'Cluster')

PKPCApcs <- data.frame(LongLat, KPCApcs)
colnames(KPCApcs) <- c('Longitude', 'Latitude', paste0('PC', 1:4))
```

```{r eigenfigs2, echo=FALSE, results='asis', fig.cap = '\\label{fig:eigenfig} Plot of singular values and Eigen values for real and randomized data set for PCA and KPCA respectively. The PCs of the start performing worse than random after component 33 for the PCA and 32 for KPCA.', fig.align = 'center', out.width='90%'}
>>>>>>> e8ad691156e418ad87283a60dbfaf1a712c94c09
## Suggests 33 PCs (97% Var)
Precipsingvals <- melt(Precipsingvals, id.vars = 'Component', 
                    variable.name = 'Data', value.name = 'SingVal')

singvalplot <- ggplot(Precipsingvals, aes(x = Component, y = SingVal, color = Data)) + 
               geom_line() + form + xlab('Principal Component') + ylab('Singular Value') + labs(fill = 'Data Set') + 
               theme(legend.position = c(.8, .8)) + ggtitle('PCA Singular Values')
...
## Suggests 33 PCs (97% Var)
eigenplot <- ggplot(Pkpcaeig, aes(x = Component, y = EigenVal, color = Data)) + 
             geom_line() + form + xlab('Principal Component') + ylab('Eigen Value') + labs(fill = 'Data Set') + 
             theme(legend.position = c(.8, .8)) + ggtitle('KPCA Eigen Values')
...
<<<<<<< HEAD
```{r PrecipPC1s, echo=FALSE, results='asis', fig.cap = '\\label{fig:SSTPC1s} Plot of PC1 from PCA and KPCA for precipitation data.', fig.align = 'center'}
bmap = map_data("state")
...
=======
PLLEclustout <- data.frame(LongLat, Cluster = factor(PLLEclustres$cluster))
>>>>>>> e8ad691156e418ad87283a60dbfaf1a712c94c09
...
=======
PLEclustout <- data.frame(LongLat, Cluster = factor(PLEclustres$cluster))
>>>>>>> e8ad691156e418ad87283a60dbfaf1a712c94c09
