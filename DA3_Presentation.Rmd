...
- This study examines the relationship between sea surface temperatures (henceforth SST) patterns in the tropical Pacific Ocean and precipitation over North America
- We wanted to predict precipitation levels based on SST, both contemporaneously and on a future-time basis
- Methods used include: dimension reduction by principal components analysis, LLE, and Laplacian Eigenmaps, persistence and climatology baseline models, random forests, ridge regression, lasso regression, GAM regression, and convolutional neural networks
